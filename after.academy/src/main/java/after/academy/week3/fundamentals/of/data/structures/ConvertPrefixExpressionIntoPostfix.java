...
public class ConvertPrefixExpressionIntoPostfix {

	private static String convertPrefixExpressionIntoPostfix(String expression) {
		
		System.out.println("Given Prefix expression ====> "+expression);
	...
	private static String accumulateExpression(String op1,String op2,char expressionVal,StringBuilder sb) {
		...
		case '+':
			 sb.append(op1).append(op2).append("+ ");
			break;
	...
	public static void main(String[] args) {
		...
		//System.out.println(ConvertPrefixExpressionIntoPostfix.convertPrefixExpressionIntoPostfix("-+23/*48^22"));
		System.out.println("POST Expression ====> "+ConvertPrefixExpressionIntoPostfix.convertPrefixExpressionIntoPostfix("-+AB/*/*CD^EFG^HI"));
